...
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'myinspect', 'static'),  # ✅ Your app’s static folder
]
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'sahilsn2005@gmail.com'  # Use environment variable
EMAIL_HOST_PASSWORD ='brha djpa hcst vite'  # Use environment variable
